...
import com.github.lucasfodev.astraeon.viewmodel.OceanViewModel
        ...
        Box(modifier = Modifier.fillMaxSize()) {
            ...
            HUDFrame {
                LazyColumn(
                    ...
                    item {
                        Text(
                            text = "REDE DE SENSORES ATIVOS // UPLINK_ESTABLISHED",
                    ...
                    itemsIndexed(sensors) { index, sensor ->
                        AnimatedVisibility(
                            ...
                            SensorCard(
                                sensor = sensor,
                                onClick = { onNavigateToDetails(sensor.id) }
                            )
                        }
                    }
                }
